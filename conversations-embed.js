! function(e) {
    ...
    function v({
        ...
        if (window.hubspot_live_messages_running)(0, n.warn)("duplicate instance of live chat exists on page");
        else {
    ...
    function I(e) {
        ...
        if ((0, c.getExternalApiSettings)().loadImmediately) v({
            logError: e
        });
        else {
    ...
    function b() {
        if ((0, a.hasRequiredFeatures)(window)) {
            ...
            (0, g.getIsLocal)() ? I(): e.captureErrors(() => {
                I(e)
            })
        }
    }
    ...
    class J {
        constructor(e, t, s) {
            this.loadIFrame = () => {
                (0, i.isAnyMobile)() && document.documentElement.classList.add(p.MOBILE);
        ...
        postPerfAttributes(e) {
            Math.random() < .5 && this.iframeMessage.post(o.PERF_ATTRIBUTES, {
                perfAttributes: e
            })
        }
        ...
        handleOpenChange({
            ...
            const s = document.documentElement,
                n = document.getElementById(I.PARENT_ID).getElementsByClassName(p.SHADOW_CONTAINER)[0];
            this.isOpen = e;
        ...
        requestWidgetOpen() {
            this.isOpen ? this.devLogger.log("cannot open the widget, it is already open.") : this.iframeMessage.post(o.REQUEST_OPEN)
        }
        requestWidgetClose() {
            this.isOpen ? this.iframeMessage.post(o.REQUEST_CLOSE) : this.devLogger.log("cannot close the widget, it is already closed")
        }
        handleWindowResize() {
            const e = {
        ...
        handleWidgetRefresh(e) {
            this.setWidgetData(e);
            (0, c.getWidgetDataResponseType)(this.widgetData) === g.HIDE_WIDGET ? this.removeIframe() : this.iframeMessage.post(o.REFRESH_WIDGET_DATA, Object.assign({}, this.widgetData, {}, (0, C.getIframeQueryParams)(this.embedScriptContext)))
        }
        setWidgetNotLoaded() {
            this.hasLoadedIframe = !1;
            this.isLoadingIframe = !1
        ...
        start() {
            const {
                shouldRender: e
            } = (0, E.shouldRenderWidget)(this.embedScriptContext);
            if (e) {
        ...
        var b = v(s),
            T = {
                ...
                android: {
                    ...
                    device: !b(u) && (b(c) || b(l) || b(a) || b(d)) || b(/\bokhttp\b/i)
                },
                windows: {
                    phone: b(u),
                    tablet: b(h),
    ...
    const o = (e, t = "") => (0, i.default)("string" == typeof e, "Expected %s to be a string, not a %s", t || e, typeof e);
    t.stringInvariant = o
}, function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    var s = (e, t, s, i, n, o, r, a) => {
        if (!e) {
            ...
            if (void 0 === t) e = new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
                ...
                const d = [s, i, n, o, r, a];
                let c = 0;
                e = new Error("Invariant Violation: " + t.replace(/%s/g, () => d[c++]))
            }
            e.framesToPop = 1;
            throw e
        }
    ...
    const o = (e, t = "") => (0, i.default)("object" == typeof e && null !== e, "Expected %s to be an object", t || e);
    t.objectInvariant = o
}, function(e, t, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    function d(e, t, s = i.default.SIX_MONTHS) {
        const n = [`${e}=${t}`, "expires=" + new Date(Date.now() + s).toGMTString(), "domain=" + ("." + a()), "path=/", "SameSite=Lax"];
    ...
    function c({
        ...
        const c = -1 !== s.indexOf(d) && !r.test(s),
            l = a.test(s);
        return !(!o.test(t) || c || l) && (-1 !== t.indexOf("qa") ? e === i || e === n : e === i)
    }
}, function(e, t, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    const o = (e, t) => (0, i.default)(!0 === e || !1 === e, "Expected %s to be a boolean but received a %s", t || e, typeof e);
    ...
    const o = (e, t, s) => (0, i.default)(s.indexOf(e) > -1, `Expected %s to be one of ${s.toString()} but got %s`, t, e);
    ...
    n = function() {
        return function e(t, s, n) {
            ...
            1: [function(e, t, s) {
                ...
                Object.create && (o.prototype = Object.create(null), (new o).__proto__ || (n = !1)), c.prototype.eventNames = function() {
                    var e, t, s = [];
                    ...
                    if (l.fn) {
                        ...
                        var h, f = l.length;
                        for (c = 0; c < f; c++) switch (l[c].once && this.removeListener(e, l[c].fn, void 0, !0), u) {
                            case 1:
                    ...
                    if (r.fn) r.fn !== t || i && !r.once || s && r.context !== s || d(this, o);
                    else {
                        for (var a = 0, c = [], l = r.length; a < l; a++)(r[a].fn !== t || i && !r[a].once || s && r[a].context !== s) && c.push(r[a]);
                        c.length ? this._events[o] = 1 === c.length ? c[0] : c : d(this, o)
                    }
                    return this
                }, c.prototype.removeAllListeners = function(e) {
                    var t;
                    return e ? (t = n ? n + e : e, this._events[t] && d(this, t)) : (this._events = new o, this._eventsCount = 0), this
                }, c.prototype.off = c.prototype.removeListener, c.prototype.addListener = c.prototype.on, c.prefixed = n, c.EventEmitter = c, void 0 !== t && (t.exports = c)
            }, {}]
        }, {}, [1])(1)
    }, e.exports = n()
}, function(e, t, s) {
    ...
    const o = e => (0, i.default)("function" == typeof e && null !== e, "Expected %s to be a function", e);
    ...
    const d = Object.keys(n).map(e => n[e]),
        c = e => (0, i.default)(-1 !== d.indexOf(e), "Expected a valid event type but received %s. Valid event types include %s.", e, d);
    ...
    function c({
        ...
        (0, r.isEmbeddedInProduct)({
            portalId: e
        }) && !(0, a.shouldHideWelcomeMessage)() && (0, i.setCookie)(n.cookies.HIDE_WELCOME_MESSAGE, !0, o.default.ONE_DAY)
    }
}, function(e, t, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    const a = () => {
        (0, n.setCookie)(i.cookies.HIDE_WELCOME_MESSAGE, !0, o.default.THIRTY_MINUTES)
    };
    ...
    function c() {
        ...
        const c = "undefined" != typeof messagesConfig && messagesConfig.iFrameDomain,
            l = (0, i.getUuid)(),
    ...
    class h {
        ...
        getIFrameSrc() {
            const e = (0, a.serializeQueryParameters)((0, d.getIframeQueryParams)({
        ...
        getInitialRequestUrl() {
            return (0, c.isInCMS)() ? (0, r.getCMSRequestUrl)({
    ...
    const o = (e, t = "") => (0, i.default)("number" == typeof e, "Expected %s to be a number, not a %s", t || e, typeof e);
    t.numberInvariant = o
}, function(e, t, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    function l({
        ...
        return `${(0,n.getApiDomain)(t,e)}/livechat-public/v1/message/public${d({messagesUtk:s,hubspotUtk:i,portalId:o,referrer:r,hstc:a,hssc:c,email:l,identificationToken:u})}`
    }
}, function(e, t) {
    e.exports = {
        mode: "compressed",
        ...
        bender: {
            ...
            depPathPrefixes: {
                ...
                "conversations-internal-schema": "/conversations-internal-schema/static-1.7789",
