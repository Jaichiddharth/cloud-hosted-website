! function() {
    ...
    var T, A, F, x = h ? function(t, e, n) {
        ...
        X = {
            f: h ? Y : function(t, e) {
                ...
                if (J(t, e)) return O(!W.f.call(t, e), t[e])
            }
        },
    ...
    var Dt = q("toStringTag"),
        ...
        Wt = function(t) {
            var n, r, i;
            return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof(r = Vt(n = Object(t), Dt)) ? r : Qt ? e(n) : "Object" == (i = e(n)) && "function" == typeof n.callee ? "Arguments" : i
        },
        zt = {};
    zt[q("toStringTag")] = "z";
    ...
    var Ht = w.f,
        ...
        re = function(t) {
            var e = ne(t),
                n = jt.f;
            if (n)
                for (var r, i = n(t), o = W.f, s = 0; i.length > s;) o.call(t, r = i[s++]) && e.push(r);
            return e
        },
    ...
    var rn = Object.assign,
        on = !rn || d((function() {
            ...
            for (var n = o(t), r = arguments.length, i = 1, s = jt.f, a = W.f; r > i;)
...
! function(t) {
    ...
    n.p = "//static.hsappstatic.net/collected-forms-embed-js/static-1.285/";
    n(n.s = "nhqU")
}({
    "0OQI": function(t, e, n) {
        "use strict";
    ...
    "3eCO": function(t, e, n) {
        (function(e, n) {
            ...
            var r
        }).call(this, n("3NC/").default, n("e70Z"))
    },
    "3fnM": function(t, e, n) {
        var r, i;
    ...
    "8R4/": function(t, e, n) {
        ...
        const o = {
            ...
            f = t => t ? s.qa : s.prod,
            d = t => t ? a.qa : a.prod,
            h = (t = !1, e = "") => `https://${u(e)}.${l(t)}`,
            p = (t = !1, e = "") => `https://${u(e)}.${f(t)}`,
            m = (t = !1, e = "") => `https://${u(e)}.${f(t)}`,
            b = (t = !1, e = "") => `https://${c(e)}.${d(t)}`
    },
    "8YHK": function(t, e, n) {
        "use strict";
        n.d(e, "a", (function() {
    ...
    OXtA: function(t, e) {
        t.exports = {
            ...
            bender: {
                depVersions: {
                    "collected-forms-embed-js": "static-1.285",
                    "forms-embed-utils-lib": "static-1.39",
                    outpost: "static-1.59",
                    jasmine: "static-3.99",
                    "jasmine-runner": "static-1.79",
                    quartz: "static-1.48",
                    react: "static-7.81",
                    "react-dom": "static-7.48",
                    sinon: "static-1.6"
                },
                depPathPrefixes: {
                    "collected-forms-embed-js": "/collected-forms-embed-js/static-1.285",
                    "forms-embed-utils-lib": "/forms-embed-utils-lib/static-1.39",
                    outpost: "/outpost/static-1.59",
                    jasmine: "/jasmine/static-3.99",
                    "jasmine-runner": "/jasmine-runner/static-1.79",
                    quartz: "/quartz/static-1.48",
                    react: "/react/static-7.81",
                    "react-dom": "/react-dom/static-7.48",
    ...
    S41S: function(t, e, n) {
        ...
        const s = (t = "") => "forms" + o(t),
            a = (t = "") => "exceptions" + o(t),
            u = (t = !1) => t ? "hubspotqa.com" : "hubspot.com",
            c = (t = !1) => t ? "hs-embed-reportingqa.com" : "hs-embed-reporting.com",
            l = ({
                hublet: t = "",
                isQa: e = !1
            } = {}) => `https://${s(t)}.${u(e)}/${r}`,
        ...
        class b {
            ...
            bindToWindow(t = [], e = []) {
                t.length < 1 ? console.warn("You need to specify allowlisted domains when binding to window errors or you will catch all page errors") : window.onerror = (n, r, i, o, s) => {
                    r && h(t, r) && !h(e, s.message) && "script error" !== n.toLowerCase() && this.sendReport("error", n, r, s)
                }
            }
            report(t, e, n = {}) {
                if (t) {
        ...
        class v {
            ...
            report(t, e = {}, n = "report") {
                ...
                t instanceof y.a ? this.reporter[n](t.err || new Error(t.key), Object.assign({
                    key: t.key
                }, e, {}, t.extra)) : this.reporter[n](t, e)
            }
            setup() {
                this.config = this.buildConfig();
                this.reporter = new g(this.project, this.config);
                return this
            }
        }
        e.a = v
