...
(function(a, b, c, d) {
    ...
    (function() {
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var j = f.getFbeventsModules("signalsFBEventsSendBatch"),
                        ...
                        o = f.getFbeventsModules("signalsFBEventsSendXHRForNetwork"),
                    ...
                    function B(a) {
                        ...
                        f = A(a);
                        var g = Object.prototype.hasOwnProperty.call(a, "customData") && typeof a.customData !== "undefined" && a.customData !== null;
                        g || (a.customData = {});
                        if (d.isInTest(x)) {
                            a.customData.rex = {
                                ex: "t",
                            ...
                            if (e)
                                if (o(f, a.customData, null, 0)) {
                                    b.trigger("XHR", f, a.customData);
                                    return
                                } else {
                                    t(new Error("In retry exp, XHR is supported but failed to send"));
                                    return
                                }
        ...
        f.ensureModuleRegistered("signalsFBEventsSendXHRForNetwork", function() {
            return function(g, h, i, j) {
                var k = {
                    exports: {}
                };
                ...
                (function() {
                    ...
                    function c(a, d, e, f) {
                        ...
                        g.onreadystatechange = function() {
                            g.readyState === b.DONE && (g.status !== 200 && (d.ex.retry++, c(a, d, e, f + 1)))
                        };
                        g.onerror = function() {
                            c(a, d, e, f + 1)
                        };
                    ...
                    function d(b, d) {
                        var e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : a.ENDPOINT,
                            f = arguments[3];
                        b.replaceEntry("rqm", "xhr");
                        c(b, d, e, f);
                        return !0
                    }
                    k.exports = d
