window.ContextHubKernelConfig = {
    ...
    stores: {
        ...
        "resolvedsegments-clientcontext": {
            type: "clientcontext.resolvedsegments",
            required: false
        },
        emulators: {
        ...
        Function.prototype.bind = function a(d) {
            ...
            var c = function() {
                ...
                if (this instanceof c) {
                    ...
                    h = e.apply(d, b.concat([].slice.call(arguments)))
                }
                return h
            };
            return c
...
(function(c) {
    c.ContextHub = c.ContextHub || {};
    var b = function(f, e) {
        return ((c.ContextHubKernelConfig.debug || e) && f) ? Function.prototype.bind.call(f, c.console) : function() {}
    };
    var d = function(g) {
        var f = c.console || {};
        var h = function() {};
        ContextHub.console = {
            ...
            warn: b(f.warn),
            info: b(f.info),
            error: b(f.error, true),
            debug: b(f.debug),
            time: b(f.time),
            timeEnd: b(f.timeEnd),
            timeStamp: b(f.timeStamp)
        };
        var e = g || "info";
        if (e === "info") {
            ContextHub.console.info = h;
            ContextHub.console.debug = h
        }
        if (e === "debug") {
            ContextHub.console.log = h;
    ...
    function a(e, f) {
        if (typeof e !== "undefined") {
            c.ContextHubKernelConfig.debug = e === true;
            d(f)
        }
...
(function(c, b) {
    b.ContextHub.Shared = b.ContextHub.Shared || {};
    ContextHub.Shared.pad = function(f, e) {
        var i = e || 2;
        var d = String(f);
        var h = i - d.length;
        if (h > 0) {
            var g = Math.pow(10, Math.min(h, 20));
...
(function(c, b) {
    ...
    var d = function(f) {
        var h = ContextHub.Utils.Cookie.getItem(c.trim(f)) || "";
        var g = h.split(/\|/);
        var e = {};
        c.each(g, function(m, i) {
            var l = i.match(/(^.*?):=(.*)/);
            if (l && (l.length === 3)) {
                l.shift();
                var j = l.shift();
...
(function(f, i) {
    ...
    var g = function() {
        return i.document.cookie ? i.document.cookie.split(/;/) : []
    };
    var c = function(o) {
        return decodeURIComponent(f.trim(o.split(/\=/)[0]))
    };
    var b = function(o) {
        return decodeURIComponent(f.trim(o.split(/\=/).slice(1).join("=")))
    };
    var k = function(r, p) {
        var o = f.type(p);
        if (o === "object" && f.isArray(p)) {
            o = "array"
        }
        switch (o) {
            case "regexp":
    ...
    var n = function(o) {
        var r = typeof o === "undefined";
        var q = g();
        var p = [];
        f(q).each(function(s, u) {
            var t = c(u);
            if (t.length && (f.inArray(t, p) === -1) && (r || k(t, o))) {
                p.push(t)
            }
        });
        return p.sort()
    };
    var h = function(r, u, t) {
...
(function(c, h) {
    h.ContextHub.Utils = h.ContextHub.Utils || {};
    var e = function(m) {
        var l = null;
        if (typeof m === "string") {
            l = m.split(/(?:\s*\/+\s*)+/);
    ...
    var i = function(t, q, n) {
        ...
        if (q) {
            ...
            var m = t;
            var s = [t];
            c.each(q.slice(0, -1), function(u, v) {
                m = m[v];
                s.push(m);
            ...
            if (m) {
                ...
                q.pop();
                s.pop();
                while (s && q && (s.length > 0) && (q.length > 0)) {
                    var l = q.pop();
                    m = s.pop();
                    var p = m[l];
                    var o = c.type(p);
                    if (((o === "object") || (o === "array")) && c.isEmptyObject(p)) {
                        delete m[l]
                    } else {
                        break
                    }
    ...
    var g = function(l) {
        if (l) {
            ...
            if ((l instanceof c) || (typeof l.css === "function")) {
                return true
            }
            if ((typeof l.toString === "function") && a.test(l.toString())) {
                return true
            }
        }
        return false
    };
    var j = function(v, s, n, l, m) {
        s = s || "/";
        m = m || 0;
        var w;
        var u = [];
        ...
        if ((q === "object") || (q === "array")) {
            if (l) {
                v = ContextHub.Utils.JSON.tree.cleanup(v)
            }
            for (var t in v) {
                ...
                if ((o === "object") || (o === "array")) {
                    c.merge(u, j(r, p + "/", null, l, m + 1))
                }
            }
        }
        if (m === 0) {
            w = (typeof n === "function") ? u.sort(n) : u.sort()
        } else {
            w = u
        }
        return w
    ...
    var b = function(l, n) {
        ...
        var m = j(l, null, function(p, o) {
            var q = p.split(/\//).length;
        ...
        c.each(m, function(o, q) {
            var r = k(l, q);
            var p = c.type(r);
            if ((p === "object" || p === "array") && c.isEmptyObject(r)) {
                l = i(l, q)
            }
        });
        return l
    ...
    var d = function(l, m) {
        return c.extend(true, {}, l, m)
    };
    c.extend(ContextHub.Utils.JSON, {
        tree: {
            sanitizeKey: e,
            setItem: f,
            getItem: k,
...
(function(i, n) {
    n.ContextHub.Utils = n.ContextHub.Utils || {};
    var w = (function() {
        var F = i.grep([n.requestAnimationFrame, n.msRequestAnimationFrame, n.mozRequestAnimationFrame, n.webkitRequestAnimationFrame, n.oRequestAnimationFrame], i.isFunction).shift();
        if (!F) {
            var E = 0;
            F = function(J) {
                var G = new Date().getTime();
                var I = Math.max(0, 16 - (G - E));
                var H = n.setTimeout(function() {
                    J(G + I)
                }, I);
                E = G + I;
                return H
    ...
    var A = (function() {
        var E = i.grep([n.cancelAnimationFrame, n.cancelRequestAnimationFrame, n.msCancelRequestAnimationFrame, n.mozCancelRequestAnimationFrame, n.webkitCancelRequestAnimationFrame, n.oCancelRequestAnimationFrame], i.isFunction).shift();
        if (!E) {
            E = function(F) {
                n.clearTimeout(F)
            }
    ...
    var h = {};
    var g = {};
    var r = function(F, G, E) {
        F = (F || "").replace(/^ *| *$/g, "");
        if (F.length) {
            E = E || {};
            if (!E.hasOwnProperty("defer")) {
                E.defer = this.config.defer
            }
            m.call(this, this.config.namespace, {
                channel: F,
                data: G,
                defer: E.defer,
                _: E._ || {}
    ...
    var m = function(G, J) {
        ...
        for (var H in J._) {
            if (J._.hasOwnProperty(H) && (typeof I[H] === "undefined")) {
                I[H] = J._[H]
            }
        }
        var E = new Date().getTime() + J.defer;
        if (!I.executeAt || (J.defer === 0) || (I.executeAt > E)) {
            I.executeAt = E
        }
        if (!i.isEmptyObject(J.data)) {
            I.data.push(J.data)
        }
    ...
    var o = function(F) {
        var G = i.extend(true, {}, F, {
            data: []
        });
        var I = {};
        var L = function(X, V, U) {
            var Y = X.key || ("temp" + Math.random());
            var W = I[Y];
            var T = (W || {}).old || null;
            I[Y] = i.extend(true, {}, X);
        ...
        for (var O = 0; O < F.data.length; O++) {
            ...
            if (S.length || J.length) {
                ...
                var M;
                var P;
                for (M = 0; M < S.length; M++, E++) {
                    P = S[M];
                    L({
                        key: K + P,
                        value: null,
                        old: ContextHub.Utils.JSON.tree.getItem(R.old, P),
                        action: "remove"
                    }, O, E)
                }
                for (M = 0; M < J.length; M++, E++) {
                    P = J[M];
                    L({
                        key: K + P,
                        value: ContextHub.Utils.JSON.tree.getItem(R.value, P),
                        old: ContextHub.Utils.JSON.tree.getItem(R.old || {}, P),
                        action: "set"
                    }, O, E)
                }
            } else {
                var H = !!(R.key && R.action) && !/^\/_\//.test(R.key);
                var N = I[R.key] || {};
                if (H && (N.old === R.value)) {
                    delete I[R.key]
                } else {
        ...
        I = i.map(I, function(T) {
            return T
        }).sort(function(U, T) {
            return U._idx - T._idx
        });
        var Q = {
            set: {
                list: [],
    ...
    var u = function(E) {
        var F = E;
        if (F.indexOf(this.config.namespace + "-") !== 0) {
            F = this.config.namespace + "-" + F
        }
        if (F.indexOf(".") !== -1) {
            F = F.split(/\./).shift()
        }
    ...
    var b = function() {
        if (!this.windowBroadcast.initialized) {
            ...
            var F = n.parent;
            try {
                while (E.location.origin === F.location.origin) {
                    E = F;
                    F = F.parent;
                    if (E === n.top) {
                        break
            ...
            try {
                this.windowBroadcast.top = (this.config.broadcast === E) ? null : E
            } catch (G) {}
    ...
    var D = function(N, E) {
        ...
        E.event = F;
        if (E.overlay) {
            E = i.extend(true, E, E.overlay)
        }
        delete(this.queue[this.config.namespace] || {})[N];
        this.queueIsEmpty = i.isEmptyObject(this.queue[this.config.namespace]);
        if (!E.muteWhenNoData || (E.muteWhenNoData && (E.data.length > 0))) {
            for (var H = F.split(/:/), L = N.split(/:/), M = H.length; M > 0; M--) {
                E.channel = L.slice(0, M).join(":");
                var O = H.slice(0, M).join(":");
                P.trigger(O, E);
                if (J && J.document) {
                    var G = J.document.createEvent("Event");
                    G.initEvent(O, true, true);
                    G.data = E;
                    J.dispatchEvent(G)
                }
                if (K) {
                    ContextHub.console.debug(ContextHub.Shared.timestamp(), O, "-", E)
                }
                h[O] = true
            }
    ...
    var t = function() {
        ...
        if ((this.eventingCounter++ % this.periodicity) === 0) {
            i.each(this.queue[this.config.namespace] || {}, function(E, F) {
                if (!F.paused && new Date().getTime() > F.executeAt) {
                    D.call(this, E, F)
                }
            }.bind(this))
        }
    ...
    var z = function(F, E, G) {
        this.queue = ContextHub.Utils.JSON.tree.setItem(this.queue, "/" + this.config.namespace + "/" + F + "/" + E, G)
    };
    var x = function(F, E) {
        return ContextHub.Utils.JSON.tree.getItem(this.queue, "/" + this.config.namespace + "/" + F + "/" + E)
    };
    var v = function(E) {
        z.call(this, E, "executeAt", 0)
    };
    var k = function(E) {
        z.call(this, E, "paused", true)
    };
    var e = function(E) {
        z.call(this, E, "paused", undefined)
    };
    var l = function(E) {
        return x.call(this, E, "paused") === true
    };
    var q = function(G, I, F) {
        var K = F ? ("." + F) : "";
    ...
    var B = function(H, J, G, F) {
        ...
        if (E) {
            ...
            i(this.config.broadcast).one(H, J);
            g[H] = true
        }
    };
    var C = function(F, E) {
        F = q(F, this.config.namespace, E);
    ...
    var y = function() {
        for (var E in g) {
            if (g.hasOwnProperty(E)) {
                ContextHub.eventing.off(E)
            }
        }
        g = {}
    };
    ContextHub.Utils.Eventing = function(E) {
        this.config = i.extend(true, {}, ContextHub.Utils.Eventing.defaultConfig, E);
        ...
        return {
            log: this.log,
            trigger: r.bind(this),
            getQueue: f.bind(this),
            isRunning: d.bind(this),
            enableEventing: j.bind(this),
            disableEventing: a.bind(this),
            alreadyTriggered: u.bind(this),
            clearQueue: c.bind(this),
            flush: v.bind(this),
            pause: k.bind(this),
            resume: e.bind(this),
            isPaused: l.bind(this),
            once: B.bind(this),
            on: p.bind(this),
            off: C.bind(this),
            unbindAllHandlers: y.bind(this),
...
(function(e, f) {
    f.ContextHub.Utils = f.ContextHub.Utils || {};
    ...
    function g(l, k, m) {
        ...
        return e.extend(true, {}, {
            name: l,
            isSupported: m || function() {
                return true
            },
            getInterface: function(o) {
                var n = k.call(this, o);
                return {
                    name: l,
                    getItem: n.getItem,
    ...
    g.prototype.setItem = function(m, l, k, o) {
        var p = (k || "").match(i) && !(k || "").match(b);
        if (p && ContextHub.isOptedOut()) {
            return false
        }
    ...
    g.prototype.getItem = function(l, k) {
        var m = this.cachedTree || l();
        this.cachedTree = m;
        return ContextHub.Utils.JSON.tree.getItem(m, k)
    };
    g.prototype.removeItem = function(m, l, k) {
        var o = (k || "").match(i) && !(k || "").match(b);
        if (o && ContextHub.isOptedOut()) {
            return false
        }
        var n = this.cachedTree || l();
    ...
    var h = function() {
        var k = false;
        e(e.merge([this.config.mode], this.config.fallback || [])).each(function(l, m) {
            if (m && m.isSupported()) {
                k = true;
                this.config.mode = m
            }
    ...
    ContextHub.Utils.Persistence = function(l) {
        this.config = e.extend(true, {}, ContextHub.Utils.Persistence.defaultConfig, l);
        var m = this.config.mode;
        var n = h.call(this);
        var k = {
            initialized: n,
            usingFallback: (this.config.mode !== m),
    ...
    var j = function(m, l) {
        var k = g.prototype.setItem.bind(this, m, l);
    ...
    ContextHub.Utils.Persistence.Modes.LOCAL = new g("local", function c(l) {
        var k = l.container;
        ...
        var m = function(p) {
            var q = ContextHub.Utils.JSON.stringify(p);
            o.setItem(k, q)
        };
        return j.call(this, m, n)
    }, function a() {
        var l = "contexthub.test." + this.name;
        var k;
        try {
            var n = f.localStorage;
            n.setItem(l, l);
            k = n.getItem(l) === l;
            n.removeItem(l)
        } catch (m) {
    ...
    ContextHub.Utils.Persistence.Modes.SESSION = new g("session", function c(l) {
        var k = l.container;
    ...
    ContextHub.Utils.Persistence.Modes.COOKIE = new g("cookie", function c(l) {
        var k = l.container;
    ...
    ContextHub.Utils.Persistence.Modes.WINDOW = new g("window", function c(l) {
        var k = l.container;
        var o = l.window;
        var n = function() {
            var p = ContextHub.Utils.JSON.parse(o.name)[k];
            return (e.type(p) === "object") ? p : {}
        };
        var m = function(p) {
            var q = ContextHub.Utils.JSON.parse(o.name);
            q[k] = p;
...
(function(g, d) {
    ...
    var b = function(l) {
        ...
        for (i = 0; i < k.length; i++) {
            j = k[i];
            if (j.applies(j.store, j.priority)) {
                return j.store
            }
        }
        if (l.required === true) {
            ContextHub.console.error('No suitable store implementation found for type: "' + l.type + '".')
        }
    };
    var h = function(j) {
        var i = f;
    ...
    ContextHub.Utils.storeCandidates = {
        registerStoreCandidate: e,
        getStoreFromCandidates: b,
        getRegisteredCandidates: h,
        getSupportedStoreTypes: a
    }
}(ContextHubJQ, window));
ContextHub.console.log(ContextHub.Shared.timestamp(), "[loading] contexthub.utils - ContextHub.Utils.inheritance.js");
(function(a) {
    a.ContextHub.Utils = a.ContextHub.Utils || {};
    ContextHub.Utils.inheritance = {
        inherit: function(e, b) {
            ...
            e.prototype.uber = function(g) {
                ...
                if (i) {
                    ...
                    h = this;
                    while (h && !h.hasOwnProperty(g)) {
                        h = h.__proto__ || h.constructor.prototype
                    }
                    j = h[g];
                    if (j === this[g]) {
                        j = (h.__proto__ || h.constructor.prototype)[g]
                    }
                }
                d[g]++;
                c = j;
                if (typeof j === "function") {
                    f = j.apply(this, Array.prototype.slice.apply(arguments, [1]))
                }
                c = null;
                d[g]--;
                return f
        ...
        newInstance: function(b, c) {
            return new(b.bind.apply(b, [null].concat([].slice.call(c))))()
        }
    }
}(window));
ContextHub.console.log(ContextHub.Shared.timestamp(), "[loading] contexthub.kernel - ContextHub.js");
(function(e, h) {
    if (typeof h.ContextHubKernelConfig === "undefined") {
        ContextHub.console.error("[-] ContextHub configuration is not set!")
    }
    h.ContextHub = e.extend({
        version: "0.3.22-20180126-0923"
    }, h.ContextHub);
    var d = {};
    var n = [];
    var g = [];
        ...
        if (e.type(x) === "object") {
            ...
            if (!d[z]) {
                ...
                e.each(A, function(B, C) {
                    y.keys.all.hash[C] = true
                });
                this.eventing.trigger(ContextHub.Constants.EVENT_STORE_REGISTERED + ":" + z, {}, {
                    defer: 0,
                    _: {
    ...
    var q = function(x) {
        return ((e.type(x) === "string") && x.length) ? ContextHub.Utils.JSON.tree.getItem(d, x) : null
    };
    var t = function(x) {
        return this.getItem("/store/" + x)
    };
    var l = function(x, y) {
        this.setItem("/store/" + x, y)
    };
    var r = function(A) {
    ...
    var k = function(y) {
        ...
        var z = 0;
        var A = [];
        e.each(y, function(B, C) {
            if (C) {
                var E = ContextHub.Utils.JSON.tree.sanitizeKey(C);
                if (E[0] === "store") {
                    C = "/" + E.slice(1).join("/")
                } else {
                    E.unshift("store")
    ...
    var i = function(C, y, B, F) {
        if (e.type(C) === "string") {
            C = [C]
        }
        var z = [];
        e.each(C, function(I, H) {
            var G = "/" + ContextHub.Utils.JSON.tree.sanitizeKey(H).join("/");
            z.push(G)
        });
        C = z;
        y = y || function() {};
        ...
        var x = function(H) {
            ...
            var G = k(C);
            var I = null;
            if (e.type(H) === "undefined") {
                I = B
            }
            if (G._length === C.length) {
                I = y;
                h.clearTimeout(D)
            }
            if (I) {
    ...
    var w = function(D, y, B, F) {
        if (e.type(D) === "string") {
            D = [D]
        }
        var z = [];
        e.each(D, function(I, H) {
            var G = "/" + ContextHub.Utils.JSON.tree.sanitizeKey(H).join("/");
            z.push(G)
        });
        D = z;
        ...
        var x = function(J, H) {
            if (H) {
                ...
                var L = true;
                e.each(H, function(N) {
                    M = ContextHub.Utils.JSON.tree.setItem(M, N, true)
                });
                for (var G = 0; G < D.length; G++) {
                    if (ContextHub.Utils.JSON.tree.getItem(M, D[G])) {
                        L = false;
                        break
                    }
                }
    ...
    var a = function(x) {
        ...
        if (f === null) {
            f = ContextHub.Utils.Cookie.getItem("cq-opt-out") !== null
        }
        return f
    };
    e.extend(ContextHub, {
    ...
    ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED, function(y, z) {
        e.each(n || [], function(B, A) {
            if (A && A(B)) {
                delete n[B];
        ...
        if ((g || []).length) {
            var x = {};
            if (z.keys) {
                e.each(z.keys.all.list, function(A, B) {
                    x["/" + z.store + B] = true
                })
            }
            e.each(g || [], function(B, A) {
                if (A) {
                    A(B, x)
                }
            })
...
(function(d, b) {
    var a = "initialization-watcher";
    var c = {};
    var e = b.setTimeout(function() {
        var f = {};
        d.each(b.ContextHubKernelConfig.stores, function(g) {
            if (!c[g]) {
                f[g] = true
            }
        });
    ...
    ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_READY, function(g, h) {
        c[h.store] = true;
        var f = true;
        d.each(b.ContextHubKernelConfig.stores, function(i, j) {
            if (!c[i] && j.required) {
                f = false
            }
        });
...
(function(d, c) {
    c.ContextHub.Store = c.ContextHub.Store || {};
    var b = new ContextHub.Utils.Persistence.prototype.PersistenceMode("memory", function a(g) {
        var e = g.container;
        var j = g.storage;
        var i = function() {
            var k = ((d.type(j) === "object") ? j : {})[e];
        ...
        return {
            setItem: f.setItem.bind(this, h, i),
            getItem: f.getItem.bind(this, i),
            removeItem: f.removeItem.bind(this, h, i),
            getKeys: function() {
                return ContextHub.Utils.JSON.tree.getKeys(i())
            },
            getTree: i
        }
    });
    ContextHub.Store.Core = function() {};
    ContextHub.Store.Core.prototype.init = function(g, f) {
        this.config = d.extend(true, {}, ContextHub.Store.Core.defaultConfig, f);
        this.name = g;
        ...
        this.pauseEventing();
        d.each(this.config.initialValues || {}, function(i, j) {
            if (!this.getItem(i)) {
                this.setItem(i, j)
            }
        }.bind(this));
    ...
    ContextHub.Store.Core.prototype.reset = function(f) {
        var e = this.isEventingPaused();
        this.pauseEventing();
        if (!f) {
            this.clean()
    ...
    ContextHub.Store.Core.prototype.setItem = function(n, m, o) {
        var f = this.resolveReference(n);
        var e = this.getItem(f);
        var j = true;
        var i = typeof m;
        if (typeof e === i) {
            var g = (i === "string" || i === "number" || i === "boolean");
            if (g) {
                j = (e !== m)
            } else {
                var l = ContextHub.Utils.JSON.stringify(e);
                var k = ContextHub.Utils.JSON.stringify(m);
                j = (l.length !== k.length) || (l !== k)
            }
        }
        if (j) {
            var h = this.persistence.setItem(this.storeDataKey + "/" + f, m);
            if (h && !(o || {}).silent) {
    ...
    ContextHub.Store.Core.prototype.getItem = function(f) {
        var e = this.resolveReference(f);
        return this.persistence.getItem(this.storeDataKey + "/" + e)
    };
    ContextHub.Store.Core.prototype.removeItem = function(i, h) {
        var e = this.resolveReference(i);
        var g = false;
    ...
    ContextHub.Store.Core.prototype.getKeys = function(f) {
        var e = this.persistence.getTree();
    ...
    ContextHub.Store.Core.prototype.getTree = function(f) {
        var e = this.persistence.getItem(this.storeDataKey) || {};
        if (!f) {
            delete e._
        }
        return e
    };
    ContextHub.Store.Core.prototype.addAllItems = function(e, g) {
        var h = d.type(e);
        var f = this;
        var i = false;
        if (h === "object" || h === "array") {
            d.each(e, function(k, l) {
                var j = f.setItem(k, l, g);
                i = i || j
            })
        }
        return i
    };
    ContextHub.Store.Core.prototype.addReference = function(h, e) {
        var j = ContextHub.Utils.JSON.tree.sanitizeKey(h);
    ...
    ContextHub.Store.Core.prototype.removeReference = function(g) {
        var h = ContextHub.Utils.JSON.tree.sanitizeKey(g);
        var e = false;
        if (h) {
            e = true;
            var f = "/" + h.join("/");
    ...
    ContextHub.Store.Core.prototype.resolveReference = function(n, f) {
        var h = ContextHub.Utils.JSON.tree.sanitizeKey(n);
        var k = "/" + h.join("/");
        if (!d.isEmptyObject(this.references) && n) {
            var e = f || 5;
            var l = k;
            while ((e > 0) && l) {
                e--;
                ...
                var i = "";
                var g = j.slice(0);
                for (var m = 0; m < j.length && !this.references[i]; m++) {
                    i += "/" + j[m];
                    g.shift()
                }
                l = this.references[i];
    ...
    ContextHub.Store.Core.prototype.announceReadiness = function() {
        ...
        if (this instanceof ContextHub.Store.JSONPStore) {
            ...
            d.each(g, function(h, i) {
                e.keys.all.hash[i] = true
            })
        }
        this.eventing.trigger(ContextHub.Constants.EVENT_STORE_READY + ":" + f, {}, {
            defer: 0,
            _: {
                action: "ready",
                store: f,
    ...
    ContextHub.Store.Core.prototype.onUpdate = function(e, h) {
        var g = typeof h === "function";
        var f = this.eventChannel;
        if (g) {
            ContextHub.eventing.on(f, h.bind(this), e)
        } else {
            ContextHub.eventing.off(f, e)
        }
    }
}(ContextHubJQ, window));
ContextHub.console.log(ContextHub.Shared.timestamp(), "[loading] contexthub.generic-stores - ContextHub.Store.SessionStore.js");
(function(b, a) {
    a.ContextHub.Store = a.ContextHub.Store || {};
    ...
    ContextHub.Store.SessionStore.prototype.init = function(d, c) {
...
(function(b, a) {
    ...
    ContextHub.Store.PersistedStore.prototype.init = function(d, c) {
...
(function(c, b) {
    b.ContextHub.Store = b.ContextHub.Store || {};
    ...
    var a = function(f) {
        ...
        var d = function() {
            ...
            for (var i = 0; i < f.length; i++) {
                h = ~~(((h << 5) - h) + f.charCodeAt(i))
            }
            var g = Math.sin(h) * 10000;
            return g - Math.floor(g)
        };
        if ((e.length === 0) || (e !== f)) {
            e = "x" + e + d().toString(36).substr(2, 5)
        }
        return e
    };
    ContextHub.Store.JSONPStore.prototype.init = function(e, d) {
        this.config = c.extend(true, {}, this.config, ContextHub.Store.JSONPStore.defaultConfig, d);
    ...
    ContextHub.Store.JSONPStore.prototype.configureService = function(e, d) {
        this.config.service = d ? e : c.extend(true, {}, this.config.service, e)
    };
    ContextHub.Store.JSONPStore.prototype.resolveParameter = function(h) {
        var e = (c.type(h) === "boolean") ? String(h) : h;
        var d = e || "";
        var g = ["ContextHub.Paths."];
        if (c.type(e) === "string") {
            var f = d.match(/\$\{(contexthub|variable):[^}]+}/g);
            if (f) {
                c.each(f, function(i, m) {
                    var n = m.slice(2, -1).split(/:/);
                    var l = n.shift();
                    var j = n.shift();
                    var k = null;
                    if (l === "contexthub") {
                        k = ContextHub.persistence.getItem(j)
                    }
                    if ((l === "variable") && j) {
                        c.each(this.allowedPrefix, function(o, p) {
                            var q = j.indexOf(p) === 0;
                            if (q) {
                                k = ContextHub.Utils.JSON.tree.getItem(b, j.replace(/\./g, "/"))
                            }
                            return !q
                        })
                    }
    ...
    ContextHub.Store.JSONPStore.prototype.getServiceURL = function(h) {
        var e = this.getServiceDetails();
        var f = [];
        var i = [];
        var g;
        if (c.type(e) !== "object") {
        ...
        if (e.jsonp) {
            ...
            if (e.jsonp === true) {
                ...
                d = ("" + e.jsonp).replace(/[^a-zA-Z0-9_$]/g, "")
            }
            e.params = e.params || {};
        ...
        if (e.host) {
            if (typeof e.secure === "undefined" || e.secure === "auto") {
                f.push("//")
            } else {
                f.push(e.secure ? "https://" : "http://")
            }
            f.push(e.host);
            f.push(e.port ? (":" + e.port) : "")
        } else {
            f.push(b.location.protocol + "//" + b.location.host)
        }
        e.path = e.path || "/";
        g = "" + (h ? this.resolveParameter(e.path) : e.path);
        f.push(g);
        c.each(e.params || {}, function(j, k) {
            i.push(encodeURIComponent(j) + "=" + encodeURIComponent(h ? this.resolveParameter(k) : k))
        }.bind(this));
        if (i.length) {
            f.push((g.indexOf("?") === -1) ? "?" : "&");
            f.push(i.join("&"))
    ...
    ContextHub.Store.JSONPStore.prototype.queryService = function(d) {
        var f = this.getServiceURL(true);
        if (!f) {
            return
        }
        ...
        if ((e + this.config.service.ttl > new Date().getTime()) && (g === f)) {
        ...
        var i = c.ajax(l);
        if (!h) {
            i.done(function(m, n, o) {
                var p = ContextHub.Utils.JSON.parse(o.responseText);
    ...
    ContextHub.Store.JSONPStore.prototype.failureHandler = function(e) {
        var d = (this.config || {}).service;
        ContextHub.console.log('There was an error while accessing JSONP service in the store "' + this.name + '", configuration: ', d, ", error: ", e)
    };
    ContextHub.Store.JSONPStore.prototype.callbackFunction = function(d) {
...
(function(b, a) {
    ...
    ContextHub.Store.PersistedJSONPStore.prototype.init = function(d, c) {
...
(function(b, a) {
    a.ContextHub.SegmentEngine = {
        version: "1.0.66-20180222-1150"
    };
    ContextHub.SegmentEngine.getResolvedSegments = function(c) {
        return ContextHub.SegmentEngine.SegmentManager.getResolvedSegments(c)
    };
    ContextHub.SegmentEngine.getSegment = function(c) {
        return ContextHub.SegmentEngine.SegmentManager.getSegment(c)
    };
    ...
    ContextHub.SegmentEngine.getObjectValue = function(d) {
        ...
        if (d === null || d === undefined) {
            ...
            if (d instanceof ContextHub.SegmentEngine.Operator) {
                ...
                if (d instanceof ContextHub.SegmentEngine.Property) {
                    c = d.getValue()
                } else {
                    if (d instanceof ContextHub.SegmentEngine.ScriptReference) {
                        c = d.execute()
                    } else {
                        if (d instanceof ContextHub.SegmentEngine.SegmentReference) {
                            c = d.isResolved()
                        } else {
                            c = d
                        }
...
(function(b, a) {
    a.ContextHub.SegmentEngine = a.ContextHub.SegmentEngine || {};
    ContextHub.SegmentEngine.Property = function(d) {
        var c = ContextHub.SegmentEngine.Property;
        if (!(this instanceof c)) {
...
(function(b, a) {
    a.ContextHub.SegmentEngine = a.ContextHub.SegmentEngine || {};
    ContextHub.SegmentEngine.Operator = function(d, e) {
    ...
    ContextHub.SegmentEngine.Operator.prototype.traverse = function(e, d) {
        var c = [];
        var f = function(g) {
            if (g && (typeof g.isResolved !== "function")) {
                return
            }
            if ((typeof d === "undefined") || ((typeof d === "function") && d(g))) {
                c.push(g);
        ...
        if (ContextHub.SegmentEngine.OperatorManager.getOperator(this.operatorName)) {
            b.each(this.getOperatorArguments(), function(g, h) {
                if (h instanceof ContextHub.SegmentEngine.Operator) {
                    b.merge(c, h.traverse(e, d))
                } else {
                    f(h)
                }
            })
    ...
    ContextHub.SegmentEngine.Operator.prototype.toString = function() {
        var c = 'Operator("' + this.getOperatorName() + '"';
        b.each(this.getOperatorArguments(), function(e, d) {
            c += ", " + d
        });
        c += ") -> " + this.isResolved();
        return c
...
(function(c, a) {
    ...
    ContextHub.SegmentEngine.OperatorManager.register = function(e, d) {
        if ((typeof e === "string") && e.length && !/\.$/.test(e)) {
            b[e] = {
                operatorName: e,
                handler: d
            }
    ...
    ContextHub.SegmentEngine.OperatorManager.unregister = function(d) {
        delete b[d]
    };
    ...
    ContextHub.SegmentEngine.OperatorManager.getOperator = function(g, e) {
        var h = (g || "").split(".", 2);
        g = h.shift();
        var d = h.shift() || "";
...
(function(c, a) {
    a.ContextHub.SegmentEngine = a.ContextHub.SegmentEngine || {};
    ContextHub.SegmentEngine.Segment = function(g, j) {
        var e = ContextHub.SegmentEngine.Segment;
        if (!(this instanceof e)) {
            return ContextHub.Utils.inheritance.newInstance(e, arguments)
        }
        var f = g || {};
        if (typeof f === "string") {
            f = {
    ...
    ContextHub.SegmentEngine.Segment.prototype.register = function(d) {
    ...
    ContextHub.SegmentEngine.Segment.prototype.isResolved = function() {
        ...
        if (this.isEnabled() && this.isRegistered()) {
            d = this.condition.isResolved()
        }
        if (d !== this.cachedResult) {
            this.cachedResult = d;
    ...
    var b = function(i, e) {
        ...
        c.each(i.operatorArguments, function(l, n) {
            if (n instanceof ContextHub.SegmentEngine.Operator) {
                var o = ((e instanceof Array) ? e[e.length - 1] : e)[k];
    ...
    ContextHub.SegmentEngine.Segment.prototype.onUpdate = function(d, g) {
        var f = typeof g === "function";
        var e = this.info.updateEvent;
        if (f) {
            ContextHub.eventing.on(e, function(h, i) {
                if (i && i.keys.all.hash[this.segment]) {
                    this.handler()
                }
            }.bind({
            ...
            ContextHub.eventing.off(e, d)
        }
    };
    ContextHub.SegmentEngine.Segment.prototype.toString = function() {
        var d = '("' + this.getPath() + '", ' + this.getBoost() + ", " + this.getCondition() + ")";
...
(function(b, a) {
    a.ContextHub.SegmentEngine = a.ContextHub.SegmentEngine || {};
    ContextHub.SegmentEngine.SegmentReference = function(c) {
        var d = ContextHub.SegmentEngine.SegmentReference;
        if (!(this instanceof d)) {
            return ContextHub.Utils.inheritance.newInstance(d, arguments)
        }
...
(function(b, a) {
    ...
    ContextHub.SegmentEngine.SegmentManager.register = function(d) {
        if (!(d instanceof ContextHub.SegmentEngine.Segment) || !d.getCondition()) {
            return false
        }
        c[d.getPath()] = d;
        d.enabled = true;
    ...
    ContextHub.SegmentEngine.SegmentManager.unregister = function(d) {
        var e;
        if (d instanceof ContextHub.SegmentEngine.Segment) {
            e = d
        } else {
            e = this.getSegment(d)
        }
    ...
    ContextHub.SegmentEngine.SegmentManager.getSegment = function(d) {
        return c[d] || null
    };
    ContextHub.SegmentEngine.SegmentManager.getResolvedSegments = function(d) {
        var f = (d || {}).returnLookup === true;
        var e = f ? {} : [];
    ...
    ContextHub.SegmentEngine.SegmentManager.getUnresolvedSegments = function(d) {
        var f = (d || {}).returnLookup === true;
        var e = f ? {} : [];
        var g = ContextHub.Shared.timers.start();
        b.each(c, function(h, i) {
...
(function(b, a) {
    a.ContextHub.SegmentEngine = a.ContextHub.SegmentEngine || {};
    ContextHub.SegmentEngine.ScriptReference = function(f, e) {
        var d = ContextHub.SegmentEngine.ScriptReference;
        if (!(this instanceof d)) {
            return ContextHub.Utils.inheritance.newInstance(d, arguments)
        }
        e = [].slice.call(arguments, 1);
        ...
        for (var c = 0; c < this.scriptArguments.length; c++) {
    ...
    ContextHub.SegmentEngine.ScriptReference.prototype.dependOn = function(c) {
        ContextHub.SegmentEngine.Dependency.addDependency.call(this, c)
    };
    ...
    ContextHub.SegmentEngine.ScriptReference.prototype.execute = function() {
        ...
        if (typeof c === "function") {
            var e = this.getScriptArguments();
            var g = [];
            b.each(e, function(h, i) {
                var j = ContextHub.SegmentEngine.getObjectValue(i);
                g.push(j)
            });
            try {
                d = c.apply(this, g)
            } catch (f) {
                ContextHub.console.error('[-] [SegmentEngine] User script "' + this.getScriptName() + '" failed:', f);
                d = null
            }
        }
        if (this.cachedResult !== d) {
            this.cachedResult = d;
    ...
    ContextHub.SegmentEngine.ScriptReference.prototype.toString = function() {
        var c = this.info.className + '("' + this.getScriptName() + '"';
        b.each(this.getScriptArguments(), function(d, e) {
            if (typeof e === "string") {
                e = '"' + e + '"'
            }
            c += ", " + e
...
(function(c, b) {
    b.ContextHub.SegmentEngine = b.ContextHub.SegmentEngine || {};
    var a = {};
    ContextHub.SegmentEngine.ScriptManager = {};
    ContextHub.SegmentEngine.ScriptManager.register = function(f, e) {
        if ((typeof f === "string") && f.length && (typeof e === "function")) {
            a[f] = e;
    ...
    ContextHub.SegmentEngine.ScriptManager.unregister = function(e) {
    ...
    ContextHub.SegmentEngine.ScriptManager.unregisterAllScripts = function() {
        c.each(this.getAllScripts(), function(e) {
            this.unregister(e)
        }.bind(this))
    };
    ...
    var d = function(e) {
        ContextHub.console.error('[-] [SegmentEngine] User script "' + e + '" not found.');
        return function() {
            return null
        }
    };
    ContextHub.SegmentEngine.ScriptManager.getScript = function(e) {
        return a[e] || d(e)
    };
    ContextHub.SegmentEngine.ScriptManager.isRegistered = function(e) {
        return !!a[e]
    }
})(ContextHubJQ, window);
...
(function(c, b) {
    ...
    ContextHub.SegmentEngine.Dependency.getEmptyDependencyList = function() {
        var d = {};
        c.each(ContextHub.SegmentEngine.Dependency.allowedDependencies, function(e, f) {
            d[f.prototype.info.className] = {
                keys: [],
                updateEvent: null
            }
        });
    ...
    ContextHub.SegmentEngine.Dependency.addDependency = function(g) {
        if (!g) {
            return
        }
        ...
        var e = null;
        var d = null;
        if (g instanceof ContextHub.SegmentEngine.Property) {
            e = g.getKey();
            d = e.replace(/(^\/|\/$)/g, "").split(/\//).shift() || null
        } else {
            if (g instanceof ContextHub.SegmentEngine.ScriptReference) {
                e = g.getScriptName()
            } else {
                if (g instanceof ContextHub.SegmentEngine.SegmentReference) {
                    e = g.getSegmentPath()
                } else {
                    e = null
                }
        ...
        if (e) {
            var f = this.dependencyList[g.info.className];
            if (!f[e]) {
                f[e] = true;
                f.keys.push(e)
            }
    ...
    ContextHub.SegmentEngine.Dependency.findAllDependencies = function(i) {
        var e = (i || {}).operatorArguments;
        if (e) {
            var h = i.operatorName;
            var f = Math.min(e.length, /^(and|or)(\.|$)/.test(h) ? Number.MAX_VALUE : 2);
            var d;
            for (d = 0; d < f; d++) {
                var g = e[d];
                if (g instanceof ContextHub.SegmentEngine.Operator) {
                    ContextHub.SegmentEngine.Dependency.findAllDependencies.call(this, g)
                } else {
                    ContextHub.SegmentEngine.Dependency.addDependency.call(this, g)
                }
            }
        }
    };
    var a = function(e, g) {
        ...
        var d = null;
        if (g.channel === ContextHub.SegmentEngine.SegmentReference.prototype.info.updateEvent) {
            d = f.SegmentReference
        } else {
            if (g.channel === ContextHub.SegmentEngine.ScriptReference.prototype.info.updateEvent) {
                d = f.ScriptReference
            } else {
                if (g.channel === ContextHub.SegmentEngine.Property.prototype.info.updateEvent) {
                    d = f.Property
                } else {
                    ContextHub.console.error("[-] [SegmentEngine] Unsupported event type:", g.channel)
                }
            }
        }
        if (d && ContextHub.SegmentEngine.Dependency.isMatching(g, d)) {
            this.cachedResult = null;
            this.isResolved()
        }
    };
    ContextHub.SegmentEngine.Dependency.dependencyMonitor = function(e, g) {
        if (!(e instanceof ContextHub.SegmentEngine.Segment) && !(e instanceof ContextHub.SegmentEngine.ScriptReference)) {
            return
        }
        ...
        if (j.length) {
            j = j.join(" ");
            if (g) {
                ContextHub.eventing.on(j, a.bind(e), d)
            } else {
                ContextHub.eventing.off(j, d)
            }
        }
    };
    ContextHub.SegmentEngine.Dependency.isMatching = function(g, d) {
        var e = (d || {}).variant;
        var f = ContextHub.SegmentEngine.Dependency[e + "Handler"];
        return (typeof f === "function") ? f.call(this, g, d) : false
    };
    ContextHub.SegmentEngine.Dependency.SegmentReferenceHandler = function(f, e) {
        for (var d = 0; d < e.keys.length; d++) {
            var g = e.keys[d];
            if (f.keys.all.hash[g]) {
                return true
            }
        }
        return false
    };
    ContextHub.SegmentEngine.Dependency.ScriptReferenceHandler = function(f, e) {
        for (var d = 0; d < e.keys.length; d++) {
            var g = e.keys[d];
            if (f.keys.all.hash[g]) {
                return true
    ...
    ContextHub.SegmentEngine.Dependency.PropertyHandler = function(f, e) {
        if (e.stores[f.store]) {
            for (var d = 0; d < e.keys.length; d++) {
                var g = e.keys[d];
...
(function(g) {
    ...
    var f = function(j, i) {
        j = Number(String(j) || undefined);
        i = Number(String(i) || undefined);
        return j === i
    };
    var a = function(i) {
        if (typeof i !== "boolean") {
            i = (/^true$/i).test(g.trim(String(i)))
        }
        return i
    };
    var h = function(j, i) {
...
(function(b) {
    ...
    b.each(ContextHub.SegmentEngine.OperatorManager.getAllOperators(), function(d, c) {
        if (/^equal(\.|$)/.test(d)) {
            ContextHub.SegmentEngine.OperatorManager.register("not-" + d, a(c.handler))
        }
    })
})(ContextHubJQ);
...
(function() {
    ...
    var a = function(f, e) {
        f = Number(String(f) || undefined);
        e = Number(String(e) || undefined);
        return f < e
    };
    var c = function(f, e) {
        f = new Date(f || undefined);
...
(function(c) {
    var d = function(f, e) {
        ContextHub.console.error("[-] [SegmentEngine] Comparison operator not found:", (f + (e ? "." + e : "")));
        return function() {
            return false
        }
    };
    var b = function(g, e) {
        var f = ContextHub.SegmentEngine.OperatorManager.getOperator(g, e) || {};
    ...
    var a = function(f) {
        ...
        var e = b("equal", f);
        return function() {
            return g.apply(this, arguments) || e.apply(this, arguments)
        }
    };
    c.each(ContextHub.SegmentEngine.OperatorManager.getAllOperators(), function(h) {
        if (/^less-than(\.|$)/.test(h)) {
            var i = h.split(".", 2);
            var g = i.shift();
            var f = i.shift();
...
(function(b, a) {
    a.ContextHub.SegmentEngine.PageInteraction = a.ContextHub.SegmentEngine.PageInteraction || {};
    ...
    ContextHub.SegmentEngine.PageInteraction.getPropertyPlaceholders = function(f) {
        var d = "[" + ContextHub.SegmentEngine.PageInteraction.info.propertyHolder + (f ? '^="%1"]' : "]");
        var e = b([d.replace(/%1/, "/" + f), d.replace(/%1/, f)].join(", "));
        var c = [];
        b.each(e, function(g, h) {
            var i = ContextHub.SegmentEngine.PageInteraction.PropertyPlaceholder(h);
            if (i.isValid()) {
                c.push(i)
            }
        });
...
(function(b, a) {
    a.ContextHub.SegmentEngine.PageInteraction = a.ContextHub.SegmentEngine.PageInteraction || {};
    var c = function() {
        var e = this.element.attr(ContextHub.SegmentEngine.PageInteraction.info.propertyHolder);
        if (!this.element || !e) {
            this.storeName = null;
            this.keyName = null;
        ...
        this.processors = [];
        b.each((this.element.attr(ContextHub.SegmentEngine.PageInteraction.info.processorHolder) || "").split(/,/), function(f, g) {
            var h = b.trim(g);
            if (h.length) {
                this.processors.push(h)
            }
        }.bind(this))
    };
    ContextHub.SegmentEngine.PageInteraction.PropertyPlaceholder = function(e) {
        var d = ContextHub.SegmentEngine.PageInteraction.PropertyPlaceholder;
        if (!(this instanceof d)) {
            return ContextHub.Utils.inheritance.newInstance(d, arguments)
        }
        this.element = b(e);
    ...
    ContextHub.SegmentEngine.PageInteraction.PropertyPlaceholder.prototype.update = function(h) {
        c.call(this);
        var i = h;
        var f = this.getValueProcessors();
        if (!i) {
            i = ContextHub.get(this.getKey())
        }
        if (!i || (i === "")) {
            i = this.getDefaultValue()
        }
...
(function(c, b) {
    b.ContextHub.SegmentEngine.PageInteraction = b.ContextHub.SegmentEngine.PageInteraction || {};
    var d = {};
    ContextHub.SegmentEngine.PageInteraction.PropertyProcessor = {};
    ContextHub.SegmentEngine.PageInteraction.PropertyProcessor.register = function(f, e) {
    ...
    ContextHub.SegmentEngine.PageInteraction.PropertyProcessor.unregister = function(e) {
        delete d[e]
    };
    ...
    ContextHub.SegmentEngine.PageInteraction.PropertyProcessor.getProcessor = function(e) {
        return d[e] || a
    }
})(ContextHubJQ, window);
...
(function(b, a) {
    ...
    var c = function(f) {
        ...
        if (ContextHub.Constants.MODE === "ui") {
            var g = new RegExp("[?&]wcmmode=([^&#]*)").exec(a.location.href);
            if (g && (g.length > 1)) {
                g = (g[1] || "").toLowerCase()
            } else {
                g = ContextHub.Utils.Cookie.getItem("wcmmode")
            }
            if (d[g]) {
                e += ((f.indexOf("?") === -1) ? "?" : "&") + "wcmmode=" + g
            }
        }
        return e
    };
    ContextHub.SegmentEngine.PageInteraction.Teaser = function(f) {
        var e = ContextHub.SegmentEngine.PageInteraction.Teaser;
        if (!(this instanceof e)) {
            return ContextHub.Utils.inheritance.newInstance(e, arguments)
        }
        f = f || {};
        this.details = {
            locationId: b.trim(f.locationId),
            variants: f.variants || [],
            strategy: b.trim(f.strategy),
            trackingURL: b.trim(f.trackingURL)
        };
        this.register()
    };
    ...
    ContextHub.SegmentEngine.PageInteraction.Teaser.prototype.updatePlaceholder = function() {
        var f = this.getBestCandidate();
        var e = null;
        if (f) {
            var g = this.currentlyLoaded || {};
            e = c(f.url);
            if ((g.path === f.path) && (g.url === e)) {
                return
            }
        }
        if (f) {
            this.currentlyLoaded = b.extend(true, {}, f, {
                url: e
            });
            this.getVariantContent(e, function(i) {
                var h = b("#" + this.details.locationId);
                h.html(i);
    ...
    ContextHub.SegmentEngine.PageInteraction.Teaser.prototype.getVariantContent = function(h, g, i) {
        var e = ContextHub.SegmentEngine.PageInteraction.Cache.get(h);
        if (e) {
            g.call(this, e.content, e.status, e.xhr);
            return
        }
        var f = {
            url: h,
        ...
        var j = b.ajax(f);
        j.done(function(l, k, m) {
            ContextHub.SegmentEngine.PageInteraction.Cache.set(h, {
                content: l,
                status: k,
                xhr: m,
                url: h
    ...
    ContextHub.SegmentEngine.PageInteraction.Teaser.prototype.getBestCandidate = function() {
        ...
        var j = [];
        var n = [];
        var m = ContextHub.SegmentEngine.SegmentManager.getResolvedSegments({
            returnLookup: true
        });
        ...
        if ((j.length === 0) || (this.details.strategy === "random")) {
            j = [].concat.call(j, n)
        }
        if (j.length) {
            j.sort(function(s, r) {
                return r.boost - s.boost
            });
...
(function(b, a) {
    ...
    ContextHub.SegmentEngine.PageInteraction.TeaserManager.register = function(d) {
        if (!(d instanceof ContextHub.SegmentEngine.PageInteraction.Teaser)) {
            return false
        }
        c[d.getTeaserId()] = d;
    ...
    ContextHub.SegmentEngine.PageInteraction.TeaserManager.unregister = function(d) {
        var e;
        if (d instanceof ContextHub.SegmentEngine.PageInteraction.Teaser) {
            e = d
        } else {
    ...
    ContextHub.SegmentEngine.PageInteraction.TeaserManager.getTeaser = function(d) {
        return c[d] || null
    };
    ContextHub.SegmentEngine.PageInteraction.TeaserManager.refreshAllTeasers = function(f) {
        if (f) {
...
(function(d, c) {
    c.ContextHub.SegmentEngine.PageInteraction = c.ContextHub.SegmentEngine.PageInteraction || {};
    var a = {};
    ContextHub.SegmentEngine.PageInteraction.StrategyManager = {};
    ContextHub.SegmentEngine.PageInteraction.StrategyManager.register = function(g, e, f) {
    ...
    ContextHub.SegmentEngine.PageInteraction.StrategyManager.unregister = function(e) {
        delete a[e]
    };
    ...
    ContextHub.SegmentEngine.PageInteraction.StrategyManager.getStrategy = function(e) {
        return a[e] || b
    };
    ContextHub.SegmentEngine.PageInteraction.StrategyManager.chooseCandidate = function(f, e) {
        var g = ContextHub.SegmentEngine.PageInteraction.StrategyManager.getStrategy(e);
...
(function(c, b) {
    ...
    ContextHub.SegmentEngine.PageInteraction.Cache.set = function(d, e) {
        a[d] = e
    };
    ContextHub.SegmentEngine.PageInteraction.Cache.get = function(d) {
        return a[d] || null
    };
    ContextHub.SegmentEngine.PageInteraction.Cache.getAllItems = function() {
        return a || {}
    };
    ContextHub.SegmentEngine.PageInteraction.Cache.clear = function(d) {
        delete a[d]
    };
...
(function() {
    ...
    var c = function(d) {
        return String(d).toLowerCase().replace(/(^| )+(.)/g, function(e) {
...
(function() {
    var a = function(c) {
        ...
        return [
            [b.getFullYear(), d(b.getMonth() + 1), d(b.getDay())].join("-"), [d(b.getHours()), d(b.getMinutes()), d(b.getSeconds())].join(":")
        ].join(" ")
    };
...
(function(d, c) {
    var b = c.MutationObserver || c.WebKitMutationObserver;
    if (b) {
        var a = {
            childList: true,
            attributes: true,
        ...
        d(function() {
            var e = new b(function(g) {
                var j = "[" + ContextHub.SegmentEngine.PageInteraction.info.propertyHolder + "]";
                var i = [];
                for (var f = 0; f < g.length; f++) {
                    var h = g[f];
                    d.merge(i, d(h.addedNodes).filter(j));
                    if (h.attributeName && h.target) {
                        i.push(h.target)
                    }
                }
                d.each(d.unique(i), function(k, l) {
                    var m = ContextHub.SegmentEngine.PageInteraction.PropertyPlaceholder(l);
                    if (m.isValid()) {
                        m.update()
                    }
                })
    ...
    d(function() {
        var e = ContextHub.SegmentEngine.PageInteraction.getPropertyPlaceholders();
...
(function(b) {
    var a = "page-interaction";
    ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED, function(e, f) {
        var d = (f || {}).store;
        var c = ContextHub.SegmentEngine.PageInteraction.getPropertyPlaceholders(d);
        b.each(c, function(g, l) {
            var h = l.getPropertyName();
...
(function(b) {
    ...
    var e = 0;
    var c = function() {
        var f = ContextHub.SegmentEngine.PageInteraction.TeaserManager.getAllTeasers();
    ...
    ContextHub.eventing.once([ContextHub.Constants.EVENT_ALL_STORES_READY, ContextHub.Constants.EVENT_STORES_PARTIALLY_READY], function() {
        var f = [ContextHub.Constants.EVENT_SEGMENT_UPDATED, ContextHub.Constants.EVENT_STORE_UPDATED + ":campaign", ContextHub.Constants.EVENT_TEASER_REGISTERED];
        ContextHub.eventing.off(f, "teaser-updater");
        ContextHub.eventing.on(f, function() {
            var g = e === 0;
...
(function(d, g) {
    ...
    var b = function(l) {
        ...
        if (typeof m === "undefined") {
            n = (l.screen.width > l.screen.height) ? "landscape" : "portrait";
            k = "normal"
        } else {
            if (m === -90 || m === 90) {
                n = "landscape";
    ...
    var j = function() {
        ...
        if (m) {
            ...
            m = m.sort(function(p, o) {
                if (p.family === o.family) {
                    return (p.version < o.version) ? -1 : 1
                }
    ...
    var a = function() {
        ...
        if (!n && m.indexOf("Windows") !== -1) {
            ...
            k = l[o];
            if (k === "98" && m.indexOf("Win 9x 4.90") !== -1) {
                k = "ME"
            }
        }
        if (!n && m.match(/Linux/)) {
        ...
        if (!n && m.match(/Android/)) {
            n = "Android";
            k = (m.match("Android ([0-9.]*)") || [""]).pop()
        }
        return {
            name: (n || "Unresolved"),
            version: (k || "Unresolved")
        }
    };
    ...
    i.prototype.readData = function() {
        ...
        if (!p) {
            var k = g.devicePixelRatio || 1;
            var n = g.screen.colorDepth;
            p = h("display", {
                resolution: {
                    width: g.screen.width * k,
                    height: g.screen.height * k
                },
                devicePixelRatio: k,
                colorDepth: n,
                nrOfColors: Math.pow(2, n),
                pixelsPerInch: f(),
                orientation: b(g)
            }).display.resolution
        }
        if (!this.getItem("window")) {
            var m = h("window", {
                dimension: {
                    width: d(g).innerWidth() * k,
                    height: d(g).innerHeight() * k
                }
            }).window.dimension;
            h("window", {
                percentageUsage: Math.floor(((m.width * m.height) / (p.width * p.height)) * 100) / 100
            })
        }
...
(function(c) {
    ...
    var d = function(g) {
        var e = 24 * 3600 * 365.25 * 1000;
        var f = new Date(g).getTime();
        return ~~((Date.now() - f) / e)
    };
    var b = function(f, e) {
        this.config = c.extend(true, {}, a, e);
        this.init(f, this.config);
        this.onUpdate("age-update", function(i, j) {
            var h = j.keys.set.hash["/birthday"];
            if (h) {
                var g = this;
                window.setTimeout(function() {
                    g.setItem("age", d(h.value))
                }, 50)
            }
        });
        this.queryService(false)
    ...
    b.prototype.successHandler = function(g) {
        this.pauseEventing();
        var j = this.getItem("path");
        if (j) {
            j = Granite.HTTP.externalize(j)
        }
        var e = c.extend(true, {}, g.profile);
        var i = !!ContextHub.Utils.JSON.tree.getItem(e, "/photos/primary/image");
        var h = /\/(jcr|sling|):/;
        c.each(ContextHub.Utils.JSON.tree.getKeys(e), function(m, n) {
            if (n.match(h)) {
                e = ContextHub.Utils.JSON.tree.removeItem(e, n)
            }
        });
        e = ContextHub.Utils.JSON.tree.setItem(e, "path", j);
        if (i) {
            e = ContextHub.Utils.JSON.tree.setItem(e, "avatar", j + "/profile/photos/primary/image")
        }
        if (e.birthday) {
            e = ContextHub.Utils.JSON.tree.setItem(e, "age", d(e.birthday))
        }
        e.authorizableId = e.authorizableId || g["rep:authorizableId"];
        var f = "anonymous";
        if (e.givenName && e.familyName) {
            f = parent.Granite.I18n.get("{0} {1}", [e.givenName, e.familyName], "name display order: {0} is the given (first) name, {1} the family (last) name")
        } else {
            if (e.givenName) {
                f = e.givenName
            } else {
    ...
    b.prototype.loadProfile = function(f) {
        var e = ContextHub.getStore("profile");
...
(function(a) {
    ...
    ContextHub.Store.ClientContextBackedStore.prototype.init = function(c, b) {
        this.uber("init", c, b);
        this.config = a.extend(true, {}, this.config, ContextHub.Store.ClientContextBackedStore.defaultConfig, b)
    };
    ContextHub.Store.ClientContextBackedStore.prototype.successHandler = function(d) {
        ...
        this.pauseEventing();
        this.setItem("/", {});
        a.each(this.config.mappingConfig.propertyMapping, function(h, i) {
            g[i] = true;
        ...
        if (this.config.mappingConfig.mapOtherProperties) {
            var e = ClientContext.get(c).data || {};
    ...
    ContextHub.Store.ClientContextBackedStore.prototype.queryService = function(d, c) {
        var e = this.config.mappingConfig.clientContextStoreName;
        var b = this;
        var f = function() {
            var g = ClientContext.get(e);
            var h = b.isEventingPaused();
            b.pauseEventing();
            if (g) {
                g.addListener("update", function() {
                    if (b.preventSelfUpdating !== true) {
                        b.successHandler(c)
                    }
                });
                b.successHandler(c)
        ...
        if (ClientContext.get(e)) {
            f()
        } else {
            CQ_Analytics.ClientContextMgr.addListener("storeregister", function(h, g) {
                if (g.STORENAME === e) {
                    f()
                }
            })
    ...
    ContextHub.Store.ClientContextBackedStore.prototype.setItem = function(c, d) {
        this.uber("setItem", c, d);
        if (this.config.mappingConfig.replicateToClientContext && (this.preventSelfUpdating !== true)) {
            var b = c.replace(/^\//, "");
            if (b.length) {
                var e = this.config.mappingConfig.propertyMapping[b];
                if (!e && this.config.mappingConfig.mapOtherProperties) {
                    e = b
                }
                if (e) {
                    ClientContext.set(this.config.mappingConfig.clientContextStoreName + "/" + e, d)
                }
            }
        }
    };
    ContextHub.Store.ClientContextBackedStore.prototype.removeItem = function(d) {
        this.uber("removeItem", d);
        if (this.config.mappingConfig.replicateToClientContext && (this.preventSelfUpdating !== true)) {
            var b = d.replace(/^\//, "");
            if (b.length) {
                var e = this.config.mappingConfig.propertyMapping[b];
                ...
                if (e) {
                    var c = CQ_Analytics.StoreRegistry.getStore(this.config.mappingConfig.clientContextStoreName);
                    if (c) {
                        c.removeProperty(e)
                    }
                }
...
(function(c) {
    ...
    d.prototype.loadProfile = function(e) {
        var f = (e || "").split("/").pop();
        if (f.length) {
    ...
    d.prototype.reset = function() {
        var e = ClientContext.get(this.config.mappingConfig.clientContextStoreName);
        if (e) {
            e.reset()
        }
    };
    ContextHub.Utils.storeCandidates.registerStoreCandidate(d, "granite.profile", 10, function() {
...
(function(d, c) {
    ...
    function b(f, e) {
        ...
        ContextHub.eventing.on(ContextHub.Constants.EVENT_DATA_UPDATE, function(g, h) {
            if (h.store !== "resolvedsegments") {
                CQ_Analytics.ClientContextMgr.fireEvent("storeupdate")
            }
        })
    }
    ContextHub.Utils.inheritance.inherit(b, ContextHub.Store.PersistedStore);
    b.prototype.getResolvedSegments = function() {
        var g = [];
        var f = CQ_Analytics.SegmentMgr;
        var e = 0;
        d.each(f.getResolved(), function(i, h) {
            var j = {
                label: f.getLabel(h),
                link: f.getLink(h),
                path: h
    ...
    ContextHub.Utils.storeCandidates.registerStoreCandidate(b, "clientcontext.resolvedsegments", 0, function() {
...
(function(c, f) {
    ...
    function e() {
        var g = {
            type: "screen",
            width: c.innerWidth || document.documentElement.clientWidth,
            height: c.innerHeight || document.documentElement.clientHeight,
            "device-width": c.screen.width,
            "device-height": c.screen.height,
            "device-pixel-ratio": 1,
            resolution: b(),
            scan: "progressive",
            grid: false,
            color: c.screen.colorDepth,
            "color-index": c.screen.pixelDepth,
            monochrome: 0
        };
    ...
    a.getNativeDevice = e;
    a.prototype = {};
    Object.defineProperty(a.prototype, "appliedStyleSheet", {
        get: function() {
            var h = true,
                g = this._appliedStyleSheet;
            ...
            if (!this._appliedStyleSheet || h) {
                this._appliedStyleSheet = d(this.document)
            }
            return this._appliedStyleSheet
        }
    });
    a.prototype._getRules = function() {
        var n = [],
            m = a.parser.getMediaRules(this.document),
            l, k, h, g;
        for (k = 0; k < m.length; k++) {
            g = [];
            l = a.parser.parseMediaRule(m[k].media.mediaText);
            for (h = 0; h < m[k].cssRules.length; h++) {
                g.push(m[k].cssRules[h].cssText)
            }
            n.push({
                mediaText: m[k].media.mediaText,
                cssRules: g,
                parsed: l,
                mediaRule: m[k]
            })
    ...
    a.prototype.removeMediaRules = function() {
        for (var g = 0; g < this.rules.length; g++) {
            while (this.rules[g].mediaRule.cssRules[0]) {
                this.rules[g].mediaRule.deleteRule(0)
            }
        }
    };
    ...
    a.prototype.restore = function() {
        ...
        for (k = 0; k < this.rules.length; k++) {
            try {
                l = this.rules[k];
                for (g = 0; g < l.cssRules.length; g++) {
                    l.mediaRule.insertRule(l.cssRules[g], l.mediaRule.cssRules.length)
                }
            } catch (h) {}
        }
    };
    a.prototype.applyDevice = function(l) {
        var m, k, g;
        this.clear();
        ...
        for (k = 0; k < this.rules.length; k++) {
            try {
                m = this.rules[k];
                if (a.parser.matchDevice(m.parsed, l)) {
                    for (g = 0; g < m.cssRules.length; g++) {
                        this.appliedStyleSheet.sheet.insertRule(m.cssRules[g], this.appliedStyleSheet.sheet.cssRules.length)
                    }
                }
            } catch (h) {}
        }
    };
    a.prototype.prepareDevice = function(h) {
        var g = {
            type: h.type || "screen",
            "device-pixel-ratio": h["device-pixel-ratio"] || 1,
            resolution: h.resolution || 96,
            scan: h.scan || "progressive",
            grid: !!h.grid,
            color: h.color || 8,
            "color-index": h["color-index"] || 0,
            monochrome: h.monochrome || 0
        };
...
(function(k, e) {
    var m = /^(?:(only|not)?\s*([_a-z][_a-z0-9-]*)|(\([^\)]+\)))(?:\s*and\s*(.*))?$/i,
        a = /^\(\s*([_a-z-][_a-z0-9-]*)\s*(?:\:\s*([^\)]+))?\s*\)$/,
        b = /^(?:(min|max)-)?(.+)/,
        j = /(em|rem|px|cm|mm|in|pt|pc)?\s*$/,
        g = /(dpi|dpcm|dppx)?\s*$/;
    ...
    function h(r) {
        ...
        for (var o = 0; o < u.length; o++) {
            try {
                q = u[o];
                v = q.cssRules;
                for (var n = 0; n < (v ? v.length : 0); n++) {
                    s = v[n];
                    if (s.type === CSSRule.MEDIA_RULE) {
                        t.push(s)
                    }
                }
            } catch (p) {}
    ...
    function d(n) {
        return n.split(",").map(function(r) {
            var q = r.trim().match(m),
                p = ((q[3] || "") + (q[4] || "")).trim().match(/\([^\)]+\)/g),
                o = {};
            o.not = !!q[1] && q[1].toLowerCase() === "not";
            o.type = q[2] ? q[2].toLowerCase() : "all";
            o.expressions = p ? p.map(function(u) {
                var t = u.match(a),
                    s = t[1].toLowerCase().match(b);
                return {
                    modifier: s[1],
                    feature: s[2],
                    value: t[2]
    ...
    function i(p, q) {
        ...
        for (var o = 0; o < p.length; o++) {
            ...
            s = r.expressions.every(function(x) {
                var u = x.feature,
                    t = x.modifier,
                    w = x.value,
                    v = q[u];
                ...
                switch (u) {
                    case "orientation":
                    case "scan":
                        return v.toLowerCase() === w.toLowerCase();
                    case "width":
                    case "height":
                    case "device-width":
                    case "device-height":
...
(function(c) {
    ...
    d.prototype.detectNativeDevice = function() {
        ...
        return {
            ...
            platform: e,
            platformVersion: g,
            canRotate: !(/mac os x|windows/i).test(e)
        }
    };
    d.prototype.getSupportedEmulators = function() {
        return c.merge([this.detectNativeDevice()], this.config.defaultEmulators)
    };
    d.prototype.emulateDevice = function(f) {
        var e = f ? this.getDeviceById(f) : ContextHub.get("emulators/currentDevice");
        if (e && this.mediaEmulator) {
            this.setItem("currentDeviceId", e.id);
            this.setItem("currentDevice", e);
            if (f === "native") {
                this.mediaEmulator.restore()
            } else {
                this.mediaEmulator.applyDevice(e)
            }
            this.eventing.trigger("emulating-device:" + e.id, {
                device: e
            })
        }
        return e
    };
    d.prototype.getDeviceById = function(g) {
        var e = null;
...
(function(c) {
    ...
    d.prototype.queryService = function(e) {
        if (ContextHub.isOptedOut()) {
            return
        }
        this.uber("queryService", e)
    };
    d.prototype.reloadSegments = function() {
        this.reset()
    };
    var b = function(g) {
        var e;
    ...
    d.prototype.refreshData = function() {
        var f = [];
        var e;
        c.each(ContextHub.SegmentEngine.getResolvedSegments(), function(i, k) {
            var h = k.getPath();
            if (h) {
                var g = h + ".html";
                var j = {
                    label: k.getTitle() || k.getName() || h,
                    link: g,
                    path: h
                };
                f.push(j)
    ...
    d.prototype.getResolvedSegments = function() {
        return ContextHub.SegmentEngine.SegmentManager.getResolvedSegments()
    };
    d.prototype.getUnresolvedSegments = function() {
        return ContextHub.SegmentEngine.SegmentManager.getUnresolvedSegments()
    };
    ContextHub.Utils.storeCandidates.registerStoreCandidate(d, "aem.segmentation", 0, function() {
...
(function(d, c) {
    ...
    function b(g, f) {
        this.config = d.extend({}, a, f);
        this.init(g, this.config);
        var e = this,
            h = 1;
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":profile", function(i, j) {
            e.setItem("tickle", h++)
        });
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":cart", function(i, j) {
            e.setItem("tickle", h++)
        })
    }
    ContextHub.Utils.inheritance.inherit(b, ContextHub.Store.PersistedStore);
    b.prototype.recent = function(k, f) {
        var l = this.getItem("products") || [],
            e = [],
            g = ContextHub.getStore("cart");
        if (!g) {
            f = false
        }
        for (var h = l.length - 1; h >= 0 && k > 0; h--) {
            var j = l[h];
            if (f && g.containsProduct(j.path)) {
                continue
            }
            e.push(j);
            k--
    ...
    b.prototype.record = function(j, k, h, f) {
        var g = JSON.parse(JSON.stringify(this.getItem("products") || []));
        ...
        if (g.length == this.config.maxCount) {
            g.shift()
        }
        g.push({
            path: j,
    ...
    b.prototype.remove = function(g) {
        var f = JSON.parse(JSON.stringify(this.getItem("products") || []));
...
(function(b) {
    ...
    function c(f, e) {
        this.config = b.extend(true, {}, a, e);
        this.init(f, this.config);
        var d = this;
        var g = 1;
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":cart", function(h, i) {
            d.setItem("tickle", g++)
        })
    }
    ContextHub.Utils.inheritance.inherit(c, ContextHub.Store.PersistedStore);
    c.prototype.recent = function(j, e) {
        var k = this.getItem("products") || [],
            d = [],
            f = ContextHub.getStore("cart");
        if (!f) {
            e = false
        }
        for (var g = k.length - 1; g >= 0 && j > 0; g--) {
            var h = k[g];
            if (e && f.containsProduct(h.path)) {
                continue
            }
            d.push(h);
            j--
    ...
    c.prototype.record = function(h, j, g, e) {
        var f = JSON.parse(JSON.stringify(this.getItem("products") || []));
        for (var d = 0; d < f.length; d++) {
            if (f[d].path == h) {
                f.splice(d, 1);
        ...
        if (f.length == this.config.maxCount) {
            f.shift()
        }
        f.push({
            path: h,
...
(function(c) {
    ...
    var a = {
        service: {
            ...
            timeout: 1000,
            ttl: 0,
            path: "${resourcePath}.commerce.cart.json"
        }
    };
    var b = function(g, f) {
        this.config = c.extend({}, a, f);
        this.init(g, this.config);
        this.queryService(false);
        var h = this;
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":segmentation", function(i, j) {
            h.resolvePromotions()
        })
    };
    ContextHub.Utils.inheritance.inherit(b, ContextHub.Store.PersistedJSONPStore);
    b.prototype.getServiceDetails = function() {
        if (this.config.service.path) {
            var f = ContextHub.Paths.RESOURCE_PATH;
            this.config.service.path = this.config.service.path.replace(/\${resourcePath}/g, f)
        }
        return this.config.service
    };
    b.prototype.queryService = function(k, j) {
        var i = this.getServiceURL(true);
        if (!i) {
            return
        }
        if (k) {
        ...
        c.ajax({
            ...
            type: "POST",
            data: {
                cart: ContextHub.Utils.JSON.stringify(g)
            },
            timeout: l
        }).done(function(m, n, o) {
            ContextHub.Callbacks[h.name](ContextHub.Utils.JSON.parse(o.responseText));
    ...
    b.prototype.successHandler = function(f) {
        var g = this.getItem("_");
        this.setItem("/", f);
        this.setItem("_", g);
        this.updateSimulatedPrice()
    };
    b.prototype.setSimulatedPrice = function(f) {
        if (!this.getItem("/_/simulatedTotalPrice")) {
            this.setItem("/_/referenceTotalPrice", this.getItem("totalPriceFloat"), {
                silent: true
            })
        }
        this.setItem("/_/simulatedTotalPrice", f, {
            silent: true
        });
    ...
    b.prototype.updateSimulatedPrice = function() {
        var f = this.getItem("/_/simulatedTotalPrice");
        if (f && this.getItem("/_/referenceTotalPrice") == this.getItem("totalPriceFloat")) {
            this.setSimulatedPrice(f)
        } else {
            this.setItem("/_/simulatedTotalPrice", null, {
                silent: true
            })
        }
    };
    b.prototype.addProductToCart = function(g, h, k, j, i) {
        var f = JSON.parse(JSON.stringify(this.getItem("entries") || []));
        f.push({
            title: k,
            quantity: 1,
            path: g,
        ...
        if (ContextHub.getStore("abandonedproducts")) {
            ContextHub.getStore("abandonedproducts").record(h, k, j, i)
        }
    };
    b.prototype.updateQuantity = function(g, h) {
        var f = JSON.parse(JSON.stringify(this.getItem("entries") || []));
        if (f.length >= g && f[g].quantity != h) {
            f[g].quantity = h;
            this.setItem("entries", f)
        }
    };
    b.prototype.addSimulatedPromotion = function(h, j) {
        var k = this.getItem("/_/simulatedPromotions") || [],
            g = false;
        ...
        if (!g) {
            ...
            this.setItem("/_/simulatedPromotions", k, {
                silent: true
            });
            this.resolvePromotions()
        }
    };
    b.prototype.removeSimulatedPromotion = function(h) {
        var j = this.getItem("/_/simulatedPromotions") || [],
            g = -1;
        ...
        if (g >= 0) {
            j.splice(g, 1);
            this.setItem("/_/simulatedPromotions", j, {
                silent: true
            });
            this.resolvePromotions()
        }
    };
    b.prototype.getSimulatedPromotions = function() {
        return this.getItem("/_/simulatedPromotions")
    };
    b.prototype.addVoucher = function(h) {
        var f = this.getItem("vouchers") || [],
            j = false;
    ...
    b.prototype.removeVoucher = function(j) {
        var f = this.getItem("vouchers") || [],
            h = -1;
        for (var g = 0; g < f.length; g++) {
            if (f[g].path == j) {
    ...
    b.prototype.setItem = function(m, k, n) {
        if (m.indexOf("entries") == 0 || m.indexOf("promotions") == 0 || m.indexOf("vouchers") == 0) {
            var i = "/" + (ContextHub.Utils.JSON.tree.sanitizeKey(m) || []).join("/");
            var h = this.getItem(i);
            var f = h === k;
            if (!f) {
                var l = ContextHub.Utils.JSON.stringify(h);
    ...
    b.prototype.containsProduct = function(k, l) {
        var m = k ? d(k) : null,
            f = this.getItem("entries") || [];
        if (!l) {
            l = 1
        }
        for (var g = 0; g < f.length; g++) {
    ...
    b.prototype.containsPromotion = function(m, g) {
        var k = m ? d(m) : null,
            h = this.getItem("promotions") || [];
        if (!g) {
            g = "FIRED"
        }
    ...
    b.prototype.resolvePromotions = function() {
        var f = this.getItem("promotionsMap");
        if (!f) {
            return
        }
        var l = ContextHub.SegmentEngine.SegmentManager.getResolvedSegments({
                returnLookup: true
            }),
            g = {},
            k, h;
        for (k = 0; k < f.length; k++) {
            var n = f[k].segments.split(",");
        ...
        for (k = 0; k < p.length; k++) {
            if (p[k].resolve || g[p[k].path]) {
                g[p[k].path] = undefined
            } else {
                p.splice(k--, 1)
            }
        }
    ...
    b.prototype.reset = function(f) {
        this.uber("reset", f);
        this.uber("setItem", "entries", [], {
            silent: true
        });
        this.setItem("/_/simulatedPromotions", [], {
            silent: true
        });
        this.uber("setItem", "promotions", [], {
            silent: true
        });
        this.uber("setItem", "vouchers", [], {
            silent: true
        });
        this.queryService(false, true)
    };
...
(function(c) {
    ...
    var b = function(e, d) {
        this.config = c.extend({}, a, d);
        this.init(e, this.config);
        this.queryService(false);
        var f = this;
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":profile", function(g, h) {
            f.queryService(true)
        })
    };
    ...
    b.prototype.getServiceDetails = function() {
        if (this.config.service.path) {
            var d = ContextHub.Paths.RESOURCE_PATH;
            this.config.service.path = this.config.service.path.replace(/\${resourcePath}/g, d)
        }
        return this.config.service
    };
    b.prototype.successHandler = function(d) {
        var e = this.getItem("_");
        this.setItem("/", d);
        this.setItem("_", e)
    };
...
(function(b) {
    var a = {
        service: {
            ...
            timeout: 1000,
            ttl: 30 * 60 * 1000,
            path: "${variable:ContextHub.Paths.RESOURCE_PATH}.commerce.relatedproducts.json"
        }
    };
    var c = function(e, d) {
        this.config = b.extend(true, {}, a, d);
        this.init(e, this.config);
        ...
        this.queryService(false);
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":profile", function(g, h) {
            var i = ContextHub.getStore("profile").getItem("authorizableId");
            if (!f.profileLoaded) {
                f.profileLoaded = true;
                f.lastAuthorizableId = i
            } else {
                if (i != f.lastAuthorizableId) {
                    f.lastAuthorizableId = i;
                    f.queryService(true)
                }
            }
        });
        ContextHub.eventing.on(ContextHub.Constants.EVENT_STORE_UPDATED + ":cart", function(g, h) {
            var j = ContextHub.getStore("cart").getItem("entries") || [];
            var i = j.length;
            if (!f.cartLoaded) {
                f.cartLoaded = true;
                f.lastCartEntryCount = i
            } else {
                if (i !== f.lastCartEntryCount) {
                    f.lastCartEntryCount = i;
                    f.queryService(true)
                }
            }
    ...
    c.prototype.successHandler = function(d) {
        this.setItem("/", d || {})
    };
    c.prototype.products = function(g, j) {
        var h = this.getTree();
        var f = null;
        var d = [];
        for (var e = 0; e < h.length; e++) {
...
(function(d, c) {
    ...
    d.each(a.stores || {}, function(h, j) {
        var f = b.Utils.storeCandidates.getStoreFromCandidates(j);
        if (f) {
            try {
                var i = b.Shared.timers.start();
                ...
                b.console.error('Store "' + j.type + '" (', f, ") could not be initialized:", g)
            }
        }
    });
...
ContextHub.eventing.on("ui-initialized", function() {
    var a = ContextHub.UIFrame && ContextHub.UIFrame[0];
    if (a) {
        a.contentWindow.onbeforeunload = unloadEverything
    }
}, "unload-handler", true);
