...
import {
    formatHtml
} from 'sanitize-text/sanitizers/HtmlSanitizer';
import {
    LEFT_ALIGNED,
    RIGHT_ALIGNED,
    WidgetLocationProp
} from './constants/WidgetLocations';
...
const BubbleTailWrapperLocation = {
    [LEFT_ALIGNED]: css(["left:40px;right:inherit;transform:scaleX(-1);"]),
    [RIGHT_ALIGNED]: css(["left:inherit;right:40px;"])
};
export const BubbleTailWrapper = styled.div.withConfig({
    displayName: "InitialMessageBubble__BubbleTailWrapper",
    componentId: "sc-6mxmy9-1"
})(["position:absolute;bottom:-22px;", ";"], ({
    widgetLocation
}) => BubbleTailWrapperLocation[widgetLocation] || BubbleTailWrapperLocation[RIGHT_ALIGNED]);
